...
def initialize(context):
    ...
    context.posrecord = None
    context.nextsell_0 = None
    context.nextbuy_0 = None
...
def handle_data(context):
    ...
    if nexttimestr == context.PARAMS["trademinlist"][1]:
    ...
    print('总资产： ', equity)
    print(context.posrecord)
    print(context.nextsell_0)
    print(context.nextbuy_0)
    print()
